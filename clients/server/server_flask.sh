#!/usr/bin/env bash
# server_flask.sh — start the AndRep Flask renderer server.
#
# Usage (from any directory):
#   ./clients/server/server_flask.sh [--template-dir DIR] [--port PORT] [--host HOST]
#
...
exec python3 "$SCRIPT_DIR/server_flask.py" "$@"
