...
INSERT INTO articles VALUES
  -- Passive
  ( 1, 'ART001', '10 ohm ceramic resistor 1/4W 100ppm/°C tolerance ±5% ROHS compliant, bulk packaging, lot 2024-Q3',        'STD', 1, 'PCS',   0.45, '5901234123457', 'https://parts.example.com/ART001', NULL, NULL),
  ( 2, 'ART002', '100 ohm ceramic resistor 1/4W ±5% ROHS compliant, tape & reel, lot 2024-Q3',       'STD', 1, 'PCS',   0.45, '5901234123464', 'https://parts.example.com/ART002', NULL, NULL),
  ( 3, 'ART003', '1K ohm metal film resistor 1/4W ±1% tolerance, ROHS, bulk delivery lot 2024-Q4',                'STD', 1, 'PCS',   0.45, '5901234123471', 'https://parts.example.com/ART003', NULL, NULL),
  ( 4, 'ART004', '10K ohm metal film resistor 1/4W ±1% low-noise, bulk packaging September 2024',               'STD', 1, 'PCS',   0.45, '5901234123488', 'https://parts.example.com/ART004', NULL, NULL),
  ( 5, 'ART005', '100nF ceramic capacitor 50V X7R dielectric ±10%, ROHS, bulk tape lot 2025-Q2',         'STD', 1, 'PCS',   0.30, '5901234123495', 'https://parts.example.com/ART005', NULL, NULL),
  ( 6, 'ART006', '10uF electrolytic capacitor 25V 105°C low-ESR series, radial lead, lot September 2025',     'STD', 1, 'PCS',   0.55, '5901234123501', 'https://parts.example.com/ART006', NULL, NULL),
  ( 7, 'ART007', '100uF electrolytic capacitor 25V general purpose 105°C radial, bulk lot 2025-Q1',    'STD', 1, 'PCS',   0.80, '5901234123518', 'https://parts.example.com/ART007', NULL, NULL),
  ( 8, 'ART008', '470uF electrolytic capacitor 16V 105°C radial, bulk delivery confirmed lot 2025-08',    'STD', 1, 'PCS',   0.95, '5901234123525', 'https://parts.example.com/ART008', NULL, NULL),
  ( 9, 'ART009', '10uH shielded SMD inductor 2A ±20% tolerance 1210 package, special batch confirmed',                'STD', 1, 'PCS',   1.20, '5901234123532', 'https://parts.example.com/ART009', NULL, NULL),
  (10, 'ART010', 'Crystal oscillator 16MHz HC-49/U ±30ppm 18pF load capacity, lot 2025-09',                 'STD', 1, 'PCS',   0.90, '5901234123549', 'https://parts.example.com/ART010', NULL, NULL),
  -- Semiconductors
  (11, 'ART011', '1N4148 high-speed signal diode 100V 150mA DO-35, bulk pack lot 2025',                 'STD', 2, 'PCS',   0.12, '5901234123556', 'https://parts.example.com/ART011', NULL, NULL),
  (12, 'ART012', '1N4007 general-purpose rectifier diode 1A 1000V DO-41, bulk delivery lot September 2025',           'STD', 2, 'PCS',   0.18, '5901234123563', 'https://parts.example.com/ART012', NULL, NULL),
  ...
  (31, 'ART031', 'Digital pocket multimeter 600V AC/DC auto-ranging, continuity buzzer, temperature probe included',           'STD', 6, 'PCS',  18.00, '5901234123754', 'https://parts.example.com/ART031', '@data/img/ART031.svg', '@data/ART031.txt'),
  (32, 'ART032', 'Soldering iron 60W adjustable temperature 200–480°C, ceramic heater, ESD-safe grip',       'STD', 6, 'PCS',  32.00, '5901234123761', 'https://parts.example.com/ART032', '@data/img/ART032.svg', NULL),
  (33, 'ART033', 'Solderless breadboard 830 tie-points, ABS base with adhesive pads, bus strips isolated',           'STD', 6, 'PCS',   5.50, '5901234123778', 'https://parts.example.com/ART033', '@data/img/ART033.svg', NULL),
