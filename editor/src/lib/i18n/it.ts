...
const it: Record<string, string> = {
  ...
  'New template defaults': 'Valori predefiniti nuovo template',
  'Default font': 'Font predefinito',
  'Default locale': 'Locale predefinita',
  'Default currency': 'Valuta predefinita',
  'Font families': 'Famiglie di font',
  'Foreground palette': 'Palette primo piano',
  'Background palette': 'Palette sfondo',
  'Toolbar groups': 'Gruppi toolbar',
  'Band name presets': 'Preset nomi fascia',
  'Show rendering hints (page_role, variable refs)': 'Mostra suggerimenti rendering (page_role, variabili)',
  'Draft autosave': 'Salvataggio automatico bozza',
  'Single': 'Singolo',
  'Per tab': 'Per scheda',
  'Per-tab mode: draft is lost when the tab is closed. Save the template before closing.': 'Modalità per scheda: la bozza viene persa alla chiusura della scheda. Salvare il template prima di chiudere.',
